...
<div style="text-align: justify; margin-bottom: 25px;">
    <strong>С октября 2024 года</strong> работаю фриланс-аналитиком в профессиональной команде по Dota 2 — <b>Avulus</b>.
    <br><br>
    <b>Ключевые задачи:</b>
    <ul style="margin:0 0 10px 24px; padding:0;">
        ...
        <li>
            Развёртывание собственного веб-сервиса на <b>Go</b> для командной аналитики.
        </li>
        <li>
...
<div style="text-align: justify; margin-bottom: 25px;">
<strong>С февраля 2024 года</strong> в качестве фрилансера развиваю backend для мобильного приложения по управлению задачами и эмоциями.<br><br>
