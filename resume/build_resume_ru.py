...
story.append(Paragraph(
    'Backend-разработчик с 3 годами опыта на Go — от проектирования микросервисной архитектуры '
...
story.append(Paragraph('Backend-разработчик · Март 2024 — Сейчас (2.5 года+) · Удалённо', s_role))
...
story.append(Paragraph('Бакалавриат · Математическое обеспечение и администрирование информационных систем · 2022 – 2026', s_role))
