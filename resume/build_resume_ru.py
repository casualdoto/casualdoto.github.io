...
bullets_av = [
    ('Разработал и задеплоил Go-сервис, агрегирующий данные из 3 внешних API (OpenDota, STRATZ, Spectral.gg)',
     'тренерский штаб получил доступ к аналитике 24/7 вместо ручного сбора таблиц'),
    ...
    ('Построил автоматическую генерацию аналитических отчётов с визуализацией',
     'используется тренером перед каждой серией на турнирах'),
]
